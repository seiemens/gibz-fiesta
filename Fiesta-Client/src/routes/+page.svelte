...
<div  class="text-center container mx-auto w-full sm:w-2/3 my-56">
    ...
    <P class="mb-6 text-lg lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Here at <Span highlight class="text-blue-500 dark:text-blue-500">GIBZ FIEŚTA</Span> we focus on schools where technology, innovation, and capital can unlock long-term value in their students.</P>
